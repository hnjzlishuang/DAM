function result = main_svm_at(data, C, kernel_types, kernel_params)
result_dir = 'results';
result_file = fullfile(result_dir, 'svm_at', ['result_', mfilename, '.txt']);
if ~exist(fullfile(result_dir, 'svm_at'), 'dir')
    mkdir(fullfile(result_dir, 'svm_at'));
end
